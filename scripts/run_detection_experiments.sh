...
# bash scripts/run_detection_experiments.sh --datasets cifar10 atis adult --methods ours aum_b el2n_b knn_label_disagreement_b moderate_b robust_alc robust_alc_frozen dalc dalc_frozen active_label_cleaning active_label_correction graph_label_propagation cleannet misdetect_b --noise-types symmetric pairflip instance --rhos 0.2 --seeds 0 --gpus 0 1
